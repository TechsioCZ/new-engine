...
- **apps/**: Application projects
  ...
  - `herbatica`: Next.js 16 storefront app
- **libs/**: Shared libraries
  - `ui`: Component library built with Zag.js and Tailwind CSS
  - `storefront-data`: TanStack Query + Medusa storefront data layer

### Subtree Guidance
- When touching `apps/herbatica`, read `apps/herbatica/AGENTS.md` before editing.
  It overrides the root frontend-demo server assumption with Herbatica's
...
- Exception: `apps/herbatica` uses `http://localhost:3001`; follow `apps/herbatica/AGENTS.md` for Herbatica work.
