...
Env fallbacks:
  MEILISEARCH_URL
  DC_MEILISEARCH_MASTER_KEY or MEILISEARCH_MASTER_KEY
  DC_MEILISEARCH_BACKEND_API_KEY or MEILISEARCH_BACKEND_API_KEY
  DC_N1_NEXT_PUBLIC_MEILISEARCH_API_KEY or NEXT_PUBLIC_MEILISEARCH_API_KEY
EOF
}
...
master_key="${DC_MEILISEARCH_MASTER_KEY:-${MEILISEARCH_MASTER_KEY:-}}"
backend_key="${DC_MEILISEARCH_BACKEND_API_KEY:-${MEILISEARCH_BACKEND_API_KEY:-}}"
frontend_key="${DC_N1_NEXT_PUBLIC_MEILISEARCH_API_KEY:-${NEXT_PUBLIC_MEILISEARCH_API_KEY:-}}"
wait_seconds="60"
timeout_seconds="20"
retry_count="3"
