...
Medusa 2.18 backend. Source is checked by root TypeScript 7 through `scripts/typescript/projects/apps/medusa-be`; Medusa framework/CLI compiler internals use isolated TypeScript 5.9.3. Do not route source checks through that legacy compiler.
