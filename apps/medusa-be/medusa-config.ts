...
const FEATURE_PAYMENT_QR_ENABLED_DEFAULT = FEATURE_FLAG_ENABLED_VALUE
...
const FEATURE_PAYMENT_QR_ENABLED =
  (process.env.FEATURE_PAYMENT_QR_ENABLED ??
    FEATURE_PAYMENT_QR_ENABLED_DEFAULT) === FEATURE_FLAG_ENABLED_VALUE
