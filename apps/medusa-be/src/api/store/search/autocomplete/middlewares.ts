...
import { applyDefaultFilters, authenticate, type MiddlewareRoute } from '@medusajs/framework/http'
...
import { STORE_CATALOG_PRODUCTS_ALLOWED_FIELDS, STORE_CATALOG_PRODUCTS_DEFAULT_FIELDS } from '../../catalog/products/validators'
...
export const storeSearchAutocompleteRoutesMiddlewares: MiddlewareRoute[] = [
	{
		...
		middlewares: [
			...
			validateAndTransformQuery(StoreSearchAutocompleteSchema, { defaults: STORE_CATALOG_PRODUCTS_DEFAULT_FIELDS, allowed: STORE_CATALOG_PRODUCTS_ALLOWED_FIELDS, isList: true }),
