...
const VOLUME_DISCOUNT_QUERY_FIELDS = ['variants.calculated_price.calculated_amount']
...
export const storeVolumeDiscountsRoutesMiddlewares: MiddlewareRoute[] = [
	{
		...
		middlewares: [
			...
			validateAndTransformQuery(StoreVolumeDiscountsQuerySchema, { defaults: VOLUME_DISCOUNT_QUERY_FIELDS, allowed: VOLUME_DISCOUNT_QUERY_FIELDS, isList: false }),
