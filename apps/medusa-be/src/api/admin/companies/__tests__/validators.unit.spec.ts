import { AdminCreateCompany, AdminUpdateCompany } from "../validators"

describe("admin company validators", () => {
  it("accepts valid company and VAT identification numbers", () => {
    const result = AdminCreateCompany.safeParse({
      name: "Acme",
  ...
  it("rejects invalid company and VAT identification numbers", () => {
    const invalidIcoResult = AdminCreateCompany.safeParse({
      name: "Acme",
      email: "info@acme.test",
      currency_code: "czk",
    ...
    const invalidVatResult = AdminCreateCompany.safeParse({
      name: "Acme",
      email: "info@acme.test",
      currency_code: "czk",
  ...
  it("allows clearing identification fields in update payload", () => {
    const result = AdminUpdateCompany.safeParse({
