...
export const RO_POST_COMMERCE_ENVELOPE_KEYS = Object.freeze([
  "capturedAt",
...
export const RO_POST_COMMERCE_ENVIRONMENT_KEYS = Object.freeze([
  "backendBuildHash",
  "backendDeploymentId",
  "backendReleaseSha",
  "backendSlot",
...
export const stablePostCommerceJson = (value) => {
...
export const postCommerceSha256 = (value) =>
...
export const parseRoPostCommerceEnvelopeContract = (contents, options = {}) => {
  let parsed
  try {
