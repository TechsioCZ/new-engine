...
export const HERBATICA_ZBOZI_REFRESH_TOKEN_ENV = "HERBATICA_ZBOZI_REFRESH_TOKEN"
export const HERBATICA_ZBOZI_REVIEWS_API_URL =
  "https://api.zbozi.cz/v1/shop/reviews"
