...
const hasSearchTextPrefix = (
  ...
  const values = [
    ...
    ...(Array.isArray(hit.search_variant_titles)
...
export const isAcceptedProductHit = (
  ...
  return (
    ...
    hit._rankingScore >= minimumRankingScore
  )
}
...
export const selectRankedProductIds = (
  ...
  const hits = Array.isArray(rawHits)
    ? rawHits.filter((hit): hit is RankedProductHit =>
...
export const buildProductResultFilter = (
  ...
  separateVariantResults && Boolean(cleanSearchText(query))
