...
export const PRODUCT_INDEX_SETTINGS = {
	...COMMON_SETTINGS,
	searchableAttributes: ['search_identifiers', 'title', 'search_variant_titles', 'brand.title', 'categories.name', 'description', 'handle'],
	...
	sortableAttributes: ['created_at', 'title', 'facet_price', 'facet_popularity'],
...
export const CATEGORY_INDEX_SETTINGS = {
	...
	displayedAttributes: ['id', 'name', 'description', 'handle', 'parent_category_id'],
...
export const CONTENT_INDEX_SETTINGS = {
	...
	displayedAttributes: ['id', 'source_id', 'type', 'locale', 'title', 'excerpt', 'slug', 'href'],
