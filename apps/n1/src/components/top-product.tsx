...
export const TopProduct = ({ src, label }: TopProductProps) => (
  <div className="grid h-full cursor-pointer place-items-center items-start px-0 transition-[transform,box-shadow] duration-500 hover:scale-105 hover:shadow-xl">
