...
const useAddressFormTypeHelper = (d: AddressFormData) =>
  useForm({ defaultValues: d })

type AddressForm = ReturnType<typeof useAddressFormTypeHelper>
  ...
  <div className="flex flex-col gap-400">
    <div className="grid grid-cols-2 gap-300">
      <form.Field name="first_name" validators={addressValidators.first_name}>
        {(field) => (
          <TextField disabled={disabled} field={field} label="Jméno" required />
        )}
      </form.Field>
    ...
    <div className="grid grid-cols-2 gap-300">
      <form.Field name="city" validators={addressValidators.city}>
        {(field) => (
          <TextField disabled={disabled} field={field} label="Město" required />
        )}
      </form.Field>
      <form.Field
        name="country_code"
    ...
    <div className="grid grid-cols-2 gap-300">
      ...
      <form.Field name="postal_code" validators={addressValidators.postal_code}>
        {(field) => (
          <TextField
            disabled={disabled}
            field={field}
