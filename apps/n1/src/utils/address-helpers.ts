...
import {
  addressToFormData as storefrontAddressToFormData,
  DEFAULT_ADDRESS as storefrontDefaultAddress,
...
export const addressToFormData = storefrontAddressToFormData
export const DEFAULT_ADDRESS = storefrontDefaultAddress
