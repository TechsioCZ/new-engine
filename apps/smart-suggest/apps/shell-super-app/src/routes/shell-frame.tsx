...
export default function ShellFrame({ children }: ShellFrameProps) {
  ...
  return (
    <main className="shell:min-h-screen shell:overflow-x-hidden shell:bg-um-canvas shell:px-4 shell:py-4 shell:scheme-light shell:text-um-foreground shell:sm:px-6 shell:lg:px-12">
