...
export function LegacyCheckoutPaymentReturnPanel() {
  ...
  const summaryHref = resolveCheckoutStepHref("suhrn", market) as Route
  const paymentHref = resolveCheckoutStepHref("doprava-platba", market) as Route
