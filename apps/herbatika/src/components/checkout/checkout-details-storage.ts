...
export const writeStoredCheckoutState = ({
  ...
  // Persistence is best-effort: sandboxed/opaque-origin embeds deny
  // sessionStorage access and quota can be exhausted; the checkout flow
  // must keep working without it, mirroring readStoredCheckoutState.
  try {
