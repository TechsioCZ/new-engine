...
const FOOTER_COLUMNS = [
  ...
  },
  {
    ...
    links: [
      {
        href: routes.cms.detail("doprava-a-platby"),
        label: "Doprava a platby",
      },
      {
        href: routes.cms.detail("reklamacia-a-vratenie"),
      ...
      {
        href: routes.cms.detail("ochrana-osobnych-udajov"),
        label: "Ochrana osobných údajov",
      },
      { href: routes.cms.detail("cookies"), label: "Cookies" },
    ],
  },
  {
    title: "Pre partnerov",
    links: [
      { href: routes.cms.detail("affiliate"), label: "Affiliate program" },
      { href: routes.cms.detail("velkoobchod"), label: "Veľkoobchod" },
      { href: routes.cms.detail("dropshipping"), label: "Dropshipping" },
      { href: routes.cms.detail("private-label"), label: "Private label" },
    ],
  },
] as const;
  ...
  return (
    <Footer direction="vertical">
      ...
      <section className="mx-auto flex w-full max-w-footer-max flex-col items-start justify-between gap-550 px-500 py-700 lg:flex-row lg:items-center lg:gap-800">
        ...
        <StorefrontReviewTrustBadges className="lg:w-auto" size="md" />
      </section>
      ...
      <Footer.Bottom className="mx-auto max-w-footer-max flex-wrap items-center gap-400">
        <Footer.Text className="leading-normal">
          ...
          <Footer.Link
            ...
            href={routes.cms.detail("cookies")}
          >
