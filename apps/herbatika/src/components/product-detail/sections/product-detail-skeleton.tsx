    ...
    <section className="grid gap-500 xl:grid-cols-2">
      <div className="space-y-300">
        <div className="grid gap-300 md:grid-cols-[auto_minmax(0,1fr)]">
          ...
          <div className="flex aspect-square overflow-hidden rounded-lg sm:max-h-[400px] lg:max-h-[600px] xl:max-h-full">
            <Skeleton.Rectangle />
          </div>
        </div>
      ...
      <div className="space-y-300">
        <div className="space-y-300 rounded-lg border border-border-secondary bg-surface p-350">
          ...
          <div className="flex flex-wrap items-end justify-between gap-250">
            <div className="space-y-200">
              <Skeleton.Rectangle
                className="h-12 w-28 rounded-md"
                variant="secondary"
              />
            </div>
            <Skeleton.Text
              containerClassName="w-full max-w-xs bg-highlight p-200 rounded-md "
              noOfLines={2}
              size="sm"
            />
          </div>
