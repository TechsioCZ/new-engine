...
const CHECKOUT_NOTES = [
  "Výber dopravy a platby stojí na shared RadioCard semantics, ale left indicator, row body a pricing layout sú app wrapper nad týmto contractom.",
      ...
      <section className="grid gap-300 xl:grid-cols-2">
        <article className="space-y-300 rounded-md border border-border-secondary bg-surface p-400">
          <div className="space-y-100">
            <h2 className="text-lg font-semibold text-fg-primary">
              Checkout form family
            </h2>
            <SupportingText>
              Adresné polia, helper texty a typ nákupu nad current shared form a
              radio contracts.
            </SupportingText>
          </div>
          ...
          <div className="space-y-250 rounded-md bg-highlight p-400">
            ...
            <div className="grid gap-250 md:grid-cols-2">
              <FormInput
                defaultValue="Ján"
                id="checkout-first-name-preview"
                label="Meno"
                required
              />
              <FormInput
            ...
            <SupportingText className="text-fg-secondary">
              Povinné polia, helper copy a sekundárne texty zostávajú app-level
              obsah, nie shared API.
            </SupportingText>
          </div>
        </article>
        ...
        <article className="space-y-300 rounded-md border border-border-secondary bg-surface p-400">
          <div className="space-y-100">
            ...
            <SupportingText>
              Checkout výberové bloky po prechode z ručných button rows na
              shared RadioCard base s app-specific row composition.
            </SupportingText>
          </div>
      ...
      <section className="grid gap-300 xl:grid-cols-2">
        <article className="space-y-300 rounded-md border border-border-secondary bg-surface p-400">
          <div className="space-y-100">
            ...
            <SupportingText>
              Checkout summary riadky zostávajú app composition bez potreby
              ďalšej shared komponenty.
            </SupportingText>
          </div>
          <div className="space-y-150 rounded-md bg-highlight p-400">
            ...
            <div className="flex items-center justify-between gap-200 border-b border-border-primary pb-150">
              <span className="text-fg-secondary">
                Ekologická doprava kuriérom
              </span>
              <span className="text-md font-medium text-fg-primary">
                2,99 €
              </span>
            </div>
        ...
        <article className="space-y-300 rounded-md border border-border-secondary bg-surface p-400">
          <div className="space-y-100">
            ...
            <SupportingText>
              Error a success surface po odstránení starého ErrorText alebo
              ExtraText driftu.
            </SupportingText>
          </div>
          <div className="space-y-200 rounded-md bg-highlight p-400">
            ...
            <SupportingText className="text-fg-secondary">
              Potvrdzujem, že som sa oboznámil s obchodnými podmienkami a
