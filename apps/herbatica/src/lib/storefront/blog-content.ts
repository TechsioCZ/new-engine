...
export const HERBATICA_BLOG_POSTS: BlogPost[] = [
  {
    id: "blog-1",
  ...
  },
  {
    ...
    author: "Herbatica redakcia",
    authorRole: "Článok pre vás pripravila",
    authorBio:
      "Redakčný tím Herbatica pripravuje odborný obsah o zdraví, výžive a prírodnej starostlivosti.",
    authorImageSrc:
