...
import { HerbaticaAccountPopover } from "./header/herbatica-account-popover"
import { HerbaticaCartPopover } from "./header/herbatica-cart-popover"
import { HerbaticaDesktopSubmenu } from "./header/herbatica-desktop-submenu"
import {
  HEADER_ACTION_ITEMS,
  PRIMARY_NAV_ITEMS,
} from "./header/herbatica-header.navigation"
import { HERBATICA_HEADER_SUBMENU_ROOT_CONFIGS } from "./header/herbatica-header.submenu-data"
import { HerbaticaMobileMenuDialog } from "./header/herbatica-mobile-menu-dialog"
import { HerbaticaLogo } from "./herbatica-logo"
...
export function HerbaticaHeader() {
  ...
  return (
    ...
    >
      <Header.Container className="mx-auto flex w-full min-w-0 max-w-max-w items-center justify-between gap-200 px-header-lg py-header-container-y 2xl:px-header-2xl">
        <HerbaticaLogo className="min-w-0 shrink" size="lg" />
        ...
        <Header.Actions className="@max-header-desktop:hidden gap-450">
          ...
          <HerbaticaAccountPopover />
          <HerbaticaCartPopover
            cart={cart}
