...
import { HerbaticaProductCardCompact } from "@/components/herbatica-product-card-compact"
    ...
    content = (
      <div className={RECENT_PRODUCTS_GRID_CLASSNAME}>
        {RECENT_PRODUCT_SKELETON_KEYS.map((skeletonKey) => (
          <HerbaticaProductCardSkeleton key={skeletonKey} variant="compact" />
        ))}
      </div>
    )
