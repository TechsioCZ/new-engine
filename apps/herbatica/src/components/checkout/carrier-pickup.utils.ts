import type { HerbaticaLocale } from "@/lib/storefront/market-context"
...
const CARRIER_PICKUP_WIDGET_LANGUAGES = {
  ...
  "ro-RO": "ro",
  "sk-SK": "sk",
} as const satisfies Record<HerbaticaLocale, CarrierPickupWidgetLanguage>
...
export const resolveCarrierPickupWidgetLanguage = (locale: HerbaticaLocale) =>
