...
import { buildHerbaticaCheckoutAddressInput } from "@/lib/storefront/cart/address-adapter"
import {
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        const updatedCart = await updateCartAddressMutation.mutateAsync({
          ...
          shippingAddress: buildHerbaticaCheckoutAddressInput(
            effectiveCheckoutDetails.shipping
          ),
          billingAddress: buildHerbaticaCheckoutAddressInput(
