...
import { HEADER_ACTION_ITEMS } from "./herbatica-header.navigation"
import { HerbaticaMobileMenuNav } from "./herbatica-mobile-menu-nav"

const HEADER_DESKTOP_MEDIA_QUERY = "(min-width: 896px)"

export function HerbaticaMobileMenuDialog() {
  ...
  return (
    <div data-herbatica-mobile-menu-dialog-root="">
      <Dialog
