...
import {
  type HerbaticaHeaderSubmenuFeaturedItem,
  useHerbaticaHeaderSubmenu,
} from "./use-herbatica-header-submenu"

type HerbaticaDesktopSubmenuProps = {
  activeRootHandle: string | null
  onClose: () => void
}

const sortDesktopSubmenuItems = (items: HerbaticaHeaderSubmenuFeaturedItem[]) =>
...
export function HerbaticaDesktopSubmenu({
  activeRootHandle,
  onClose,
}: HerbaticaDesktopSubmenuProps) {
  const tCatalog = useTranslations("catalog")
  const tNavigation = useTranslations("navigation")
  const { categoriesQuery, groupsByRootHandle } = useHerbaticaHeaderSubmenu()
