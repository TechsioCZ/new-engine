...
import type { HerbaticaCurrencyCode } from "@/lib/storefront/currency"
import { formatCurrencyAmount } from "@/lib/storefront/price-format"
import { useCartLineItemActions } from "@/lib/storefront/use-cart-line-item-actions"
import { CartItemRow } from "./herbatica-cart-item-row"

type HerbaticaCartPopoverProps = {
  cart: HttpTypes.StoreCart | null | undefined
  cartTotalLabel: string
  currencyCode: HerbaticaCurrencyCode
  itemCount: number
}
...
type CartTotalsProps = {
  ...
  cartTotalLabel: string
  currencyCode: HerbaticaCartPopoverProps["currencyCode"]
...
export function HerbaticaCartPopover({
  cart,
  cartTotalLabel,
  currencyCode,
  itemCount,
}: HerbaticaCartPopoverProps) {
  const t = useTranslations("cart")
