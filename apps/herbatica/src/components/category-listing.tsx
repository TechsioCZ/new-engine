...
import { PRIMARY_NAV_ITEMS } from "@/components/header/herbatica-header.navigation"
import { HerbaticaBreadcrumb } from "@/components/herbatica-breadcrumb"
...
export function CategoryListing({ slug }: CategoryListingProps) {
  ...
  return (
    <main className="mx-auto flex w-full max-w-max-w flex-col gap-category-page-gap p-category-page font-rubik 2xl:p-category-page-lg">
      <HerbaticaBreadcrumb items={controller.breadcrumbItems} />
