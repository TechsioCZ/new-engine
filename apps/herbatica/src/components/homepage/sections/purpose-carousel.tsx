...
import type { HERBATICA_HEADER_SUBMENU_ROOT_CONFIGS } from "@/components/header/herbatica-header.submenu-data"
import { useHerbaticaHeaderSubmenu } from "@/components/header/use-herbatica-header-submenu"
...
type PurposeCarouselRootHandle =
  (typeof HERBATICA_HEADER_SUBMENU_ROOT_CONFIGS)[number]["rootHandle"]
