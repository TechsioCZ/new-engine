...
export type HerbaticaProductCardBaseProps = {
  product: HttpTypes.StoreProduct
  onProductHoverStart?: (product: HttpTypes.StoreProduct) => void
  onProductHoverEnd?: (product: HttpTypes.StoreProduct) => void
}

type HerbaticaProductCardStateOptions = {
  priceUnavailableLabel: string
  onImageError?: () => void
}

export function useHerbaticaProductCardState(
  product: HttpTypes.StoreProduct,
  { priceUnavailableLabel, onImageError }: HerbaticaProductCardStateOptions
) {
