...
export type RuianRequiredAddressField = "city" | "houseNumber" | "postalCode";
...
export const parseRuianAddressSnapshotRow = (
  ...
  if (city === undefined || rawHouseNumber === undefined || postalCode === undefined) {
    return {
  ...
  if (district !== undefined && normalizeSourceKey(district) !== normalizeSourceKey(city)) {
