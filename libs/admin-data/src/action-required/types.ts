...
export type ActionRequiredListParams = {
  limit: number
  offset: number
}

export type ActionRequiredSummaryInput = {
  enabled?: boolean
}

export type ActionRequiredSummaryParams = Record<string, never>

export type ActionRequiredQueryKeys = {
  all: () => QueryKey
  customers: (params: ActionRequiredListParams) => QueryKey
  orders: (params: ActionRequiredListParams) => QueryKey
  summary: (params: ActionRequiredSummaryParams) => QueryKey
}

export type ActionRequiredService = {
  getCustomers: (
  ...
  getSummary: (
    params: ActionRequiredSummaryParams,
    signal?: AbortSignal
  ) => Promise<ActionRequiredSummary>
}

export type ActionRequiredHooksConfig = {
