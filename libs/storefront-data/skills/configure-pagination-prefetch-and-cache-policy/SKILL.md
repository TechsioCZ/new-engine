...
sources:
  ...
  - "TechsioCZ/new-engine:libs/storefront-data/src/shared/cache-config.ts"
  - "TechsioCZ/new-engine:libs/storefront-data/src/shared/prefetch.ts"
  - "TechsioCZ/new-engine:libs/storefront-data/src/shared/prefetch-pages-plan.ts"
