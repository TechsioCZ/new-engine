...
Use RadioCard for prominent exclusive choices with title, description, or addon content. Use RadioGroup for simple text options.
...
```tsx
<RadioCard.Item value="pro">
  <RadioCard.ItemText>Pro</RadioCard.ItemText>
</RadioCard.Item>
```
