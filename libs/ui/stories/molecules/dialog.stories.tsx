...
const AllVariantsRender: NonNullable<Story["render"]> = () => {
  ...
  return (
    <VariantContainer>
      ...
      <VariantGroup title="Content Variations">
        ...
        >
          <p>
            The description provides more context about the dialog&apos;s
            purpose.
          </p>
        </Dialog>
...
const AlertDialogRender: NonNullable<Story["render"]> = () => {
  ...
  render: () => (
    <div className="grid grid-cols-2 gap-200">
      ...
      <Dialog
        ...
        preventScroll={false}
      >
        <p>Body scroll is still enabled!</p>
      </Dialog>
    </div>
  ),
}
...
const DrawerLeftRender: NonNullable<Story["render"]> = () => {
  const [open, setOpen] = useState(false)
...
export const DrawerLeft: Story = {
  render: DrawerLeftRender,
}

// Drawer - Right placement
const DrawerRightRender: NonNullable<Story["render"]> = () => {
  const [open, setOpen] = useState(false)
...
export const DrawerRight: Story = {
  render: DrawerRightRender,
}

// Drawer - Top placement
const DrawerTopRender: NonNullable<Story["render"]> = () => {
  const [open, setOpen] = useState(false)
...
export const DrawerTop: Story = {
  render: DrawerTopRender,
}

// Drawer - Bottom placement
const DrawerBottomRender: NonNullable<Story["render"]> = () => {
  const [open, setOpen] = useState(false)
...
export const DrawerBottom: Story = {
  render: DrawerBottomRender,
}

// Drawer sizes showcase
const DrawerSizesRender: NonNullable<Story["render"]> = () => {
...
export const DrawerSizes: Story = {
  render: DrawerSizesRender,
}

// Mobile menu example
const MobileMenuDrawerRender: NonNullable<Story["render"]> = () => {
  const [open, setOpen] = useState(false)
...
export const MobileMenuDrawer: Story = {
  render: MobileMenuDrawerRender,
}

// Portal vs No Portal comparison - demonstrates when to use each mode
const PortalComparisonRender: NonNullable<Story["render"]> = () => {
    ...
    <div className="flex flex-col gap-600 p-400">
      ...
      <div className="grid grid-cols-2 gap-400">
        ...
        <div className="space-y-200">
          ...
          <div className="relative h-48 overflow-hidden rounded-lg border-2 border-border-primary bg-overlay p-300">
            ...
            >
              <div className="space-y-200">
                <p className="text-sm">
                  This dialog is rendered outside the container using Portal, so
                  it&apos;s not affected by the parent&apos;s overflow:hidden.
                </p>
                <p className="text-sm text-fg-secondary">
