...
const WithErrorStory: NonNullable<Story["render"]> = () => {
...
const ValidationStatesStory: NonNullable<Story["render"]> = () => {
...
// Required Field
const RequiredStory: NonNullable<Story["render"]> = () => {
...
const HorizontalLayoutStory: NonNullable<Story["render"]> = () => {
...
export const HorizontalLayout: Story = {
  render: HorizontalLayoutStory,
}

// Without Triggers - Keyboard and wheel control only
const WithoutTriggersStory: NonNullable<Story["render"]> = () => {
  const [value, setValue] = useState(50)
...
const AllSizesStory: NonNullable<Story["render"]> = () => {
...
const ComplexDemoStory: NonNullable<Story["render"]> = () => {
  const [value, setValue] = useState(50)
  const isInvalid = value < 0 || value > 100
