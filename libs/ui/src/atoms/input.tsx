...
const inputVariants = tv({
  ...
  variants: {
    size: {
      sm: "h-form-control-sm p-input-sm text-input-sm [--radius-input:var(--radius-form-control-sm)]",
      md: "h-form-control-md p-input-md text-input-md [--radius-input:var(--radius-form-control-md)]",
