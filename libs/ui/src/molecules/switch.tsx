...
const switchVariants = tv({
  slots: {
    control: [
      ...
      "data-[focus]:outline-(length:--default-ring-width) data-[focus]:outline-(style:--default-ring-style)",
      ...
      "data-[invalid]:outline-(length:--default-ring-width) data-[invalid]:outline-(style:--default-ring-style)",
